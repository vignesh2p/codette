...
public class LeaveService {
	...
	public Object getHistoryLeave(Integer orgId,String status,Integer userId, String role) {
	 ...
	 @Transactional
	public Object statusChange(List<LeaveManagementDTO> leaveDTO, List<LeaveManagementDTO> leaveManagementListDTO, Integer orgId, Integer userId, Integer accessId) {
		// TODO Auto-generated method stub
