...
public class StudentTranslator extends BaseTranslator {
	...
	public List<StaffClassDTO> convertToStaffClassDTOList(Object object) {
		...
		Type listType = new TypeToken<List<StaffClassDTO>>() {
		}.getType();
	...
	private Student translateToStudent(UserDTO studentDTO) {
		...
		if (studentDTO != null) {
			...
			/*
			 * if(studentDTO.getStandard() != null && studentDTO.getSection() !=
			 * null){ Class classes = new Class(); Standard standard = new
			 * Standard(); Section section = new Section();
			 ...
			 * classes.setStandard(standard); classes.setSection(section); }
			 */
		}
		return student;
	}
	...
	public UserDTO translateToStudentDTO(Student student) throws ParseException {
		...
		if (student != null) {
			...
			if (student.getDateOfBirth() != null) {
				studentDTO.setDateOfBirth(commonUtil.formatgivenStringToDate(student.getDateOfBirth(),
						CommonConstants.DATE_DD_MMMM_YYYY, CommonConstants.DATE_FORMAT));
			}
			if (student.getDateOfJoining() != null) {
				studentDTO.setDateOfJoining(commonUtil.formatgivenStringToDate(student.getDateOfJoining(),
						CommonConstants.DATE_DD_MMMM_YYYY, CommonConstants.DATE_FORMAT));
			}
